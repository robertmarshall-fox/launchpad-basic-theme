( function( $ ) {
    ...
    //Show Header Search
	customize( 'fox_agency_header_search', function( value ) {
	...
	customize( 'fox_agency_background_colour', function( value ) {
		value.bind( function( newval ) {            
    ...
    //Update Google Fonts
	customize( 'fox_agency_heading_font_selector', function( value ) {
        value.bind( function( newval ) {    
            $.ajax({
                type       : "POST",
	...
	customize( 'fox_agency_paragraph_font_selector', function( value ) {  
        value.bind( function( newval ) {            
            $.ajax({
                type       : "POST",
                url        : ajax_customizer.ajax_url,
	...
	customize( 'fox_agency_heading_text_colour', function( value ) {
		value.bind( function( newval ) {            
	...
	customize( 'fox_agency_paragraph_text_colour', function( value ) {
		value.bind( function( newval ) {            
