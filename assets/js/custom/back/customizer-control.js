(function( $ ) {
    ...
    wp.customize.bind( 'ready', function() {
        ...
        customize.section( 'fox_agency_fonts_colours_section' ).expanded.bind( function( isExpanding ) {
            if ( isExpanding ){
                toggle_google_api_visibility();
            }
        } );
        ...
        function toggle_google_api_visibility(){
            var google_font_warning = customize.control('fox_agency_font_api_missing');   
            if ( customize( 'fox_agency_google_api' ).get().length < 0 ){
