...
if ( function_exists( 'add_theme_support' ) ) {
    ...
    load_theme_textdomain( fox_agency_text_domain(), get_template_directory() . '/languages' );
    ...
    */
     ...
     */
    function fox_agency_unregister_default_widgets() {
    ...
    add_action('widgets_init', 'fox_agency_unregister_default_widgets', 11);
