...
if ( ! function_exists( 'fox_agency_comment' ) ) {
	...
	function fox_agency_comment( $comment, $args, $depth ) {
	...
	?>
			...
			<article id="comment-<?php comment_ID(); ?>" class="comment <?php $comment->comment_type; ?>" itemprop="comment" itemscope itemtype="http://schema.org/Comment">
				...
				<footer>
					<div class="comment-meta commentmetadata">
						...
						printf( __( '%1$s at %2$s', fox_agency_text_domain() ), get_comment_date(), get_comment_time() ); ?>
						</time></a>
						<?php edit_comment_link( __( '(Edit)', fox_agency_text_domain() ), ' ' ); ?>
					</div>
				</footer>
			</article>
		<?php
		...
		<li <?php comment_class(); ?> id="li-comment-<?php comment_ID(); ?>">
			<article id="comment-<?php comment_ID(); ?>" class="comment <?php $comment->comment_type; ?>" itemprop="comment" itemscope itemtype="http://schema.org/Comment">
				...
				<?php printf( __( '%s <span class="says">says:</span>', fox_agency_text_domain() ), sprintf( '<cite class="fn p-name" itemprop="name">%s</cite>', get_comment_author_link() ) ); ?>
					</address><!-- .comment-author .vcard -->
					<?php if ( '0' === $comment->comment_approved ) : ?>
						<em><?php _e( 'Your comment is awaiting moderation.', fox_agency_text_domain() ); ?></em>
						<br />
					<?php endif; ?>
