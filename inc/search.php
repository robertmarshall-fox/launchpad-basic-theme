...
function main_search_form() {
    ...
    $form = '<form role="search" id="main-searchform" class="main-search group" method="get" action="' . esc_url( home_url( '/' ) ) . '" itemprop="potentialAction" itemscope itemtype="http://schema.org/SearchAction">';
