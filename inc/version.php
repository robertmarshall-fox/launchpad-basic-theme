 ...
 */
function fox_agency_get_file_version_number( $name, $file ){
    
    $timestamp = get_file_last_mod_stamp( $file );
    
    if( $name && $timestamp ){
        
        $version_num = fox_agency_set_file_version_number( $name, $timestamp );
 ...
 * @since FoxAgency 1.0.0
 */
function fox_agency_set_file_version_number( $name, $timestamp ){
    
    $version_option_name = 'fox_agency' . $name . '_version_number';
    ...
    //fox_agency_inc_version_number can take an empty string, or a 3 point number
    $new_version = fox_agency_inc_version_number( $current_version );
 ...
 * @since FoxAgency 1.0.0
 */
function fox_agency_inc_version_number( $version = null ){
 ...
 * @since FoxAgency 1.0.0
 */
function fox_agency_check_modif_date($timestamp, $old_stamp){
