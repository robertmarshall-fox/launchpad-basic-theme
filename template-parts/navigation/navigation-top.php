...
<div id="logo" class="logo smooth">
    ...
    <a class="smooth" href="<?php echo site_url();?>">
        ...
        //Get logo filepath
        $custom_logo =  get_theme_mod( 'fox_agency_site_logo' );
...
<div class="header-menu-wrap group">
    ...
    <!-- Main Menu -->
    <nav id="site-navigation" class="main-navigation" role="navigation" aria-label="<?php esc_attr_e( 'Top Menu', fox_agency_text_domain() ); ?>">
    ...
    if ( get_theme_mod('fox_agency_header_search', true) ) {
